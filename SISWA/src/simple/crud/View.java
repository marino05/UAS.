...
public class View extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lName, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(email, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(fName, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(delete)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(serachData, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void loadData(){
      try {
        ...
        String url = "jdbc:MySQL://localhost:3306/siswa_db";
        String user = "root";
        String pass = "";
       ...
       DefaultTableModel model = new DefaultTableModel(new String[]{"ID", "Nama Lengkap", "Nim Siswa", "Alamat Siswa"}, 0);
       ...
       while(rs.next()){
         i = rs.getString("id");
         f = rs.getString("nama_lengkap");
         l = rs.getString("nim_siswa");
         e = rs.getString("alamat_siswa");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            if("".equals(fName.getText())){
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Harap Isi Nama", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(lName.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Harap Isi Nim", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(email.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Harap Isi Alamat", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
                fN = fName.getText();
                lN = lName.getText();
                em = email.getText();
                query = "INSERT INTO user (nama_lengkap, nim_siswa, alamat_siswa) "
                        + "VALUES ('"+fN+"','"+lN+"','"+em+"')";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "Harap Isi Nomor", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
               ...
               while(rs.next()){
                 ...
                 lN = lName.getText();
                 em = email.getText();
                 String sql2 = "UPDATE user SET nama_lengkap='"+fN+"', nim_siswa='"+lN+"', alamat_siswa='"+em+"'  WHERE id="+ID;
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "Harap Isi Nomor", "Dialog",
               ...
               ResultSet rs = st.executeQuery(sql);
               while(rs.next()){
                   fName.setText(rs.getString("nama_lengkap"));
                   lName.setText(rs.getString("nim_siswa"));
                   email.setText(rs.getString("alamat_siswa"));
                   notFound = 1;
